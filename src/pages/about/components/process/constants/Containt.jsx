...
const containt = [
  {
    smallTitle: 'Lifecycle',
    bigTitle: 'Club Initiative Blueprint',
    desc: [
      <div className="p-l">Every FINBIZ initiative follows a tested blueprint that balances creativity with execution.</div>,
      <div className="p-l">Teams move from insight gathering to launch with clear checkpoints and mentorship.</div>,
      <div className="p-l">This rhythm keeps experiences student-led yet professionally delivered.</div>,
    ],
    descMobile: [
      <div className="p-l">Every FINBIZ initiative follows a blueprint that balances creativity with execution.</div>,
      <div className="p-l">Teams move from insight gathering to launch with checkpoints and mentors.</div>,
  ...
  {
    smallTitle: 'Workflow',
    bigTitle: 'Collaboration DNA',
    desc: [
      <div className="p-l">Our workflow champions transparency, shared ownership, and rapid iteration.</div>,
      <div className="p-l">Digital tools keep everyone aligned while in-person huddles drive momentum.</div>,
      <div className="p-l">The result—consistent delivery and a culture of continuous improvement.</div>,
    ],
    descMobile: [
      <div className="p-l">We champion transparency, shared ownership, and rapid iteration.</div>,
      <div className="p-l">Digital tools keep everyone aligned while in-person huddles drive momentum.</div>,
