...
const containt = [
  {
    smallTitle: 'Programs',
    bigTitle: 'Signature Learning Tracks',
    desc: [
      <div className="p-l">THE FINBIZ CLUB curates immersive learning sprints across markets, strategy, and fintech.</div>,
      <div className="p-l">Members collaborate on real-world problem statements, sharpen analysis, and present insights to mentors.</div>,
      <div className="p-l">Every track blends fundamentals with hands-on labs so knowledge sticks.</div>,
    ],
    descMobile: [
      <div className="p-l">THE FINBIZ CLUB curates immersive learning sprints across markets, strategy, and fintech.</div>,
      <div className="p-l">Collaborate on real-world problems, sharpen analysis, and present to mentors.</div>,
  ...
  {
    smallTitle: 'Community',
    bigTitle: 'Events & Engagement',
    desc: [
      <div className="p-l">We design a calendar that keeps the campus buzzing—panels, simulations, competitions, and socials.</div>,
      <div className="p-l">Students meet alumni, investors, and founders who share raw lessons from the field.</div>,
      <div className="p-l">Every experience is crafted to build confidence, networks, and momentum.</div>,
    ],
    descMobile: [
      <div className="p-l">We keep campus buzzing with panels, simulations, competitions, and socials.</div>,
      <div className="p-l">Connect with alumni, investors, and founders who share real lessons.</div>,
  ...
  {
    smallTitle: 'Support',
    bigTitle: 'Mentorship & Resources',
    desc: [
      <div className="p-l">Members receive structured guidance to move from curiosity to competence.</div>,
      <div className="p-l">We maintain resource hubs, peer mentoring pods, and office hours with faculty advisors.</div>,
      <div className="p-l">Your growth plan is personalised and supported throughout the semester.</div>,
    ],
    descMobile: [
      <div className="p-l">Get structured guidance to move from curiosity to competence.</div>,
      <div className="p-l">Access resource hubs, peer mentoring pods, and advisor office hours.</div>,
