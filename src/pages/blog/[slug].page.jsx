...
function BlogPostPage({ post }) {
  ...
  return (
    <>
      <CustomHead title={seo.title} description={seo.description} />
      <article className={clsx(styles.root, 'layout-block-inner')}>
        ...
        <section className={clsx(styles.body, 'layout-grid-inner')}>
          <div>
            ...
            {(!post.content || post.content.length === 0) && <p className="p-l">Full article content will appear here as soon as the FINBIZ editorial team completes the draft.</p>}
          </div>
        </section>
      </article>
    </>
