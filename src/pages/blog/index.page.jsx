...
const seo = {
    ...
    keywords: [
        'FINBIZ blog',
        'Adani University insights',
        'Fintech updates',
        'Campus entrepreneurship stories',
        'Business club news',
    ],
};
            ...
            <section className={clsx(styles.root, 'layout-block-inner')}>
                <div className={clsx(styles.layout, 'layout-grid-inner')}>
                    <div className={styles.hero}>
                        ...
                        <p className="p-l">Our editorial desk is preparing articles tailored for the FINBIZ Club. Until the first wave drops, preview the themes we will explore with students, partners, and mentors.</p>
