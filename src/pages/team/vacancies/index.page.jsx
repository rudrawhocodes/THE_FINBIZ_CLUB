...
const seo = {
    ...
    keywords: [
        'FINBIZ vacancies',
        'Adani University club roles',
        'student leadership openings',
        'FINBIZ recruitment',
    ],
};
            ...
            <section className={clsx(styles.root, 'layout-block-inner')}>
                <div className={clsx(styles.hero, 'layout-grid-inner')}>
                    <div className={styles.heroContent}>
                        ...
                        <p className="p-l">We are formalising new roles for the upcoming semester. Browse the upcoming opportunities below and register interest to be the first to know when applications go live.</p>
